...
translation = record
  ...
  where
    ...
    compileIdentifier Nats.neq                 = Ints.neq
    ...
    mutual
      ...
      compileTerm (`forall n Nats.NAT t) = `forall n Ints.INT (`app₂ (Ints.core Core.implies) last≥0 (compileTerm t))
      compileTerm (`forall n σ t)        = `forall n (compileSort σ) (compileTerm t)
      compileTerm (`exists n Nats.NAT t) = `exists n Ints.INT (`app₂ (Ints.core Core.implies) last≥0 (compileTerm t))
